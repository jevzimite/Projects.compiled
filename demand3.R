...
fc <- beezdemand::FitCurves(sim$simvalues, "hs", k = 4, detailed = TRUE)
beezdemand::PlotCurves(fc)

beezdemand::FitMeanCurves(sim$simvalues, "hs", k = 4, method = "Pooled")
beezdemand::GetValsForSim(apt)
beezdemand::GetK(apt)
beezdemand::GetEmpirical(apt)
