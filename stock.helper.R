...
#### SLOPE ANALYSIS ####
j = df$slope
p = round(length(j[j>0])/length(j),3)
plot(density(df$slope), main = paste('Change of rate over the last', K, 'days, prob of win =',p))
...
training = c(15)
# 15  25  34  44  54  63  73  82  92 102 111 121 131 140 150 : x axis

mapply(helper, stock = watchlist, K = training)
